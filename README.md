...
monochrome is the first open source theme for [Kirby CMS](http://getkirby.com). It is fully responsive, free and you can use it out of the box. Test the life demo [here](http://monochrome.niklausgerber.com).
